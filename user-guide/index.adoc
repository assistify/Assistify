...
include::assistify-first-steps.adoc[Erste Schritte]

include::assistify-messages-channels.adoc[Nachrichten und Kanäle]

include::assistify-notifications.adoc[Benachrichtigungen]

include::assistify-help-requests.adoc[Anfragen stellen und Hilfe beantworten]

include::assistify-live-chat.adoc[Live-Chat]

include::assistify-using-apps.adoc[Nutzung von Apps]
